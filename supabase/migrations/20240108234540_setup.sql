...
AS $$
DECLARE
 project_url TEXT := 'https://zdwzubiainrvdweweyuo.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inpkd3p1YmlhaW5ydmR3ZXdleXVvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTAwNDU5MiwiZXhwIjoyMDIwNTgwNTkyfQ.SwjoiqPp9EKrO0G7bwfYh2IX3oNEQxncGtwqhA7DlNc'; -- full access needed for http request to storage
